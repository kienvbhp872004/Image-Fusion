...
\]
Không có thông tin nào bị mất: toàn bộ nội dung của $\mathbf{x}$ được mã hóa trong $\mathbf{y}$ và có thể phục hồi hoàn toàn. CDDFuse sử dụng INN cho nhánh \emph{Detail CNN Encoder} để đảm bảo thông tin modality-specific (tần số cao) không bị mất khi mã hóa.
