...
Đồ án đề xuất CDDFuse-AG --- cải tiến CDDFuse thông qua chiến lược \textbf{quy tắc tổng hợp bất đối xứng} cho hai nhánh Base và Detail. Thực nghiệm trên Harvard Medical Image Fusion (72 cặp kiểm thử, 3 modality) cho thấy hầu hết các thang đo vượt trội đều tập trung vào nhóm chỉ số phản ánh \textbf{chi tiết và tần số cao}: SF, AG, EI, Qabf, QM --- cho thấy mô hình đề xuất có khả năng \emph{giữ chi tiết thông tin tốt hơn} so với các phương pháp so sánh.
