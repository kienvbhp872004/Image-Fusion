...
nb["cells"][10]["source"] = [
    ...
    "!python train_asymmetric.py --variant $VARIANT --pretrained $PRETRAINED --num_epochs $EPOCHS --batch $BATCH --coeff_decomp 2.0 --seed $SEED --output /kaggle/working/ $amp_flag",
]
